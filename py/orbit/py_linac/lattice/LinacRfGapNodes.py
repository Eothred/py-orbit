...
from orbit.mod.linac import BaseRfGap, MatrixRfGap, RfGapTTF, RfGapThreePointTTF
from orbit.mod.linac import BaseRfGap_slow, RfGapTTF_slow, RfGapThreePointTTF_slow
